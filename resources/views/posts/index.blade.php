        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    ...
                    <h5 class="text-center"><a href="#">PPW2</a></h5>         
                    <hr>
                </div>
                            ...
                            <tbody>
                              @forelse ($posts as $post)
                                <tr>
                                    ...
                                    <td>{!! $post->content !!}</td>
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="/{{ $post->id }}" method="POST">
                                            <a href="/{{ $post->id }}" class="btn btn-sm btn-dark">SHOW</a>
